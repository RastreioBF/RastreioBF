...
class DoneTableViewCell: UITableViewCell {
    ...
    static let identifierDone: String = "DoneTableViewCell"
...
//        self.productTimeLabel.text = data.time
    ...
    func setupConstraints(){
        NSLayoutConstraint.activate([
            ...
            self.productStatusImage.centerYAnchor.constraint(equalTo: self.codeTrakingLabel.centerYAnchor),
            self.productStatusImage.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -40),
            self.productStatusImage.heightAnchor.constraint(equalToConstant: 35),
            self.productStatusImage.widthAnchor.constraint(equalToConstant: 35),
